...
var CrisisMarkers = []string{
	...
	// Уход из дома / выгоняют.
	"убегу из дома", "уйду из дома", "выгоняют из дома", "выгнал из дома",
}
